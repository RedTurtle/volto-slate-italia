...
- syncCreateTableBlock crea un blocco di tipo 'slateTable' e non 'table':
  'table' era il vecchio blocco tabella DraftJS, non più registrato da Volto 18
  (volto-slate registra solo 'slateTable' in blocks/Table/index.js), quindi una
  tabella incollata da HTML generava un blocco non riconosciuto
...
- syncCreateTableBlock aggiunge alla tabella incollata i flag di stile di
  ...
  @plone/volto-slate/blocks/Table/TableBlockEdit): senza di essi la tabella
  veniva renderizzata senza bordi e con un layout diverso da quelle inserite
  dal blocco.
 ...
 * @see initialTable in @plone/volto-slate/blocks/Table/TableBlockEdit
 */
